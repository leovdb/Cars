...
<head>
    ...
    <meta property="og:url" content="http://www.driven-cars.com/WhatsMyCarWorth" />
    <meta property="og:image" content="http://www.driven-cars.com/WhatsMyCarWorth/hero.jpg">
...
<body>
            ...
            <table class="quote-table" width="750" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td valign="middle" width="100%">
                        <p class="quote large-font quote-background">"What a brilliant service from the the Driven team - they did a really good job. They took all the work off my hands and got my car sold for a great price with minimal stress." - Dom, Driven customer</p>
                    </td>
                    <td valign="middle" id="testamonial-img-cell"><img src="dom.gif" id="testamonial-img" />
                    </td>
    ...
    <div id="body-container">
        ...
        <!--<h2 id="what-we-do">Why you should let us sell your car</h2>

        <table border="0" cellspacing="0" cellpadding="0" id="callout-table">
            <tr>
                <td class="circle-callout"><span class="large-font">Another driver will typically pay <p class="blue-highlight">10-20% more</p> for your car than a dealer</span></td>
                <td class="circles-cell">
                    <div class="small-circle no-mobile"></div>
                    <div class="small-circle"></div>
                </td>
                <td class="circle-callout"><span class="large-font">But selling a car yourself is a lot of hassle</span></td>
                <td class="circles-cell">
                    <div class="small-circle no-mobile"></div>
                    <div class="small-circle"></div>
                </td>
                <td class="circle-callout"><span class="large-font">We’ll sell your car, taking care of all the hassle. You’ll get more money</span></td>
            </tr>
        </table>
-->
        <h2 id="why-use-us">Why you should sell your car with Driven</h2>

        <p class="section-kicker large-font">Another driver will typically pay <strong>10-20% more</strong> money for your car than a dealer.</p>

        <p class="section-kicker large-font">But selling a car yourself is a lot of hassle.</p>
